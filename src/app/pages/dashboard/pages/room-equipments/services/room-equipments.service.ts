...
export class RoomEquipmentsService {
  ...
  getRoomEquipments() {
    ...
    const url = 'https://fitness-club-manager-backend.onrender.com/room-equipment';
  ...
  deleteRoomEquipment(roomId: number, equipmentId: number) {
    ...
    const url = `https://fitness-club-manager-backend.onrender.com/room-equipment/${roomId}/${equipmentId}`;
